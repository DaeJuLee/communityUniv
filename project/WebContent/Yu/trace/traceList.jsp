					...
					if (totCnt > 0) {
						for (int i = 0; i < list.size(); i++) {
							...
							if (id.equals("admin") || id == "admin") {
								...
								out.println("<td><a href = 'homeMainPage.jsp?pgm=../adminPage/traceListDelete.jsp?bnum="
			...
			<%
				int pageCnt = (int) Math.ceil((double) totCnt / pageSize);
					...
					if (startPage > blockSize) {
						out.println("<a class = 'prev'  href='homeMainPage.jsp?pgm=../Yu/trace/traceList.jsp?pageNum="
					...
					if (endPage < pageCnt) {
						out.println("<a class = 'next ir href='homeMainPage.jsp?pgm=../Yu/trace/traceList.jsp?pageNum="
